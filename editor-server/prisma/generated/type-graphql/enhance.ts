...
const crudResolversMap = {
  ...
  EditingLEDEffect: crudResolvers.EditingLEDEffectCrudResolver,
...
const actionResolversMap = {
  ...
  EditingLEDEffect: {
    aggregateEditingLEDEffect: actionResolvers.AggregateEditingLEDEffectResolver,
    createManyEditingLEDEffect: actionResolvers.CreateManyEditingLEDEffectResolver,
    createOneEditingLEDEffect: actionResolvers.CreateOneEditingLEDEffectResolver,
    deleteManyEditingLEDEffect: actionResolvers.DeleteManyEditingLEDEffectResolver,
    deleteOneEditingLEDEffect: actionResolvers.DeleteOneEditingLEDEffectResolver,
    findFirstEditingLEDEffect: actionResolvers.FindFirstEditingLEDEffectResolver,
    findFirstEditingLEDEffectOrThrow: actionResolvers.FindFirstEditingLEDEffectOrThrowResolver,
    editingLEDEffects: actionResolvers.FindManyEditingLEDEffectResolver,
    editingLEDEffect: actionResolvers.FindUniqueEditingLEDEffectResolver,
    getEditingLEDEffect: actionResolvers.FindUniqueEditingLEDEffectOrThrowResolver,
    groupByEditingLEDEffect: actionResolvers.GroupByEditingLEDEffectResolver,
    updateManyEditingLEDEffect: actionResolvers.UpdateManyEditingLEDEffectResolver,
    updateOneEditingLEDEffect: actionResolvers.UpdateOneEditingLEDEffectResolver,
    upsertOneEditingLEDEffect: actionResolvers.UpsertOneEditingLEDEffectResolver
  },
  Dancer: {
...
const crudResolversInfo = {
  ...
  EditingLEDEffect: ["aggregateEditingLEDEffect", "createManyEditingLEDEffect", "createOneEditingLEDEffect", "deleteManyEditingLEDEffect", "deleteOneEditingLEDEffect", "findFirstEditingLEDEffect", "findFirstEditingLEDEffectOrThrow", "editingLEDEffects", "editingLEDEffect", "getEditingLEDEffect", "groupByEditingLEDEffect", "updateManyEditingLEDEffect", "updateOneEditingLEDEffect", "upsertOneEditingLEDEffect"],
...
const argsInfo = {
  ...
  AggregateEditingLEDEffectArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyEditingLEDEffectArgs: ["data", "skipDuplicates"],
  CreateOneEditingLEDEffectArgs: ["data"],
  DeleteManyEditingLEDEffectArgs: ["where"],
  DeleteOneEditingLEDEffectArgs: ["where"],
  FindFirstEditingLEDEffectArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstEditingLEDEffectOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyEditingLEDEffectArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueEditingLEDEffectArgs: ["where"],
  FindUniqueEditingLEDEffectOrThrowArgs: ["where"],
  GroupByEditingLEDEffectArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyEditingLEDEffectArgs: ["data", "where"],
  UpdateOneEditingLEDEffectArgs: ["data", "where"],
  UpsertOneEditingLEDEffectArgs: ["where", "create", "update"],
...
const relationResolversMap = {
  LEDEffect: relationResolvers.LEDEffectRelationsResolver,
  ...
  EditingLEDEffect: relationResolvers.EditingLEDEffectRelationsResolver,
...
const relationResolversInfo = {
  LEDEffect: ["editing"],
  User: ["editingPositionFrameId", "editingControlFrameId", "editingLEDEffectId"],
  EditingPositionFrame: ["user", "editingFrame"],
  EditingControlFrame: ["user", "editingFrame"],
  EditingLEDEffect: ["user", "editingLEDEffect"],
...
const outputsInfo = {
  AggregateColor: ["_count", "_avg", "_sum", "_min", "_max"],
  ColorGroupBy: ["id", "color", "colorCode", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  AggregateEditingLEDEffect: ["_count", "_avg", "_sum", "_min", "_max"],
  EditingLEDEffectGroupBy: ["userId", "LEDEffectId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  PartGroupBy: ["id", "dancerId", "name", "type", "length", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ColorCountAggregate: ["id", "color", "colorCode", "_all"],
  ColorAvgAggregate: ["id", "colorCode"],
  ColorSumAggregate: ["id", "colorCode"],
  ColorMinAggregate: ["id", "color"],
  ColorMaxAggregate: ["id", "color"],
  ...
  EditingLEDEffectCountAggregate: ["userId", "LEDEffectId", "_all"],
  EditingLEDEffectAvgAggregate: ["userId", "LEDEffectId"],
  EditingLEDEffectSumAggregate: ["userId", "LEDEffectId"],
  EditingLEDEffectMinAggregate: ["userId", "LEDEffectId"],
  EditingLEDEffectMaxAggregate: ["userId", "LEDEffectId"],
  ...
  PartCountAggregate: ["id", "dancerId", "name", "type", "length", "_all"],
  PartAvgAggregate: ["id", "dancerId", "length"],
  PartSumAggregate: ["id", "dancerId", "length"],
  PartMinAggregate: ["id", "dancerId", "name", "type", "length"],
  PartMaxAggregate: ["id", "dancerId", "name", "type", "length"],
  ...
  LoggerAvgAggregate: ["id", "user"],
  LoggerSumAggregate: ["id", "user"],
...
const inputsInfo = {
  ColorWhereInput: ["AND", "OR", "NOT", "id", "color", "colorCode"],
  ColorOrderByWithRelationInput: ["id", "color", "colorCode"],
  ColorWhereUniqueInput: ["id", "color"],
  ColorOrderByWithAggregationInput: ["id", "color", "colorCode", "_count", "_avg", "_max", "_min", "_sum"],
  ColorScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "color", "colorCode"],
  LEDEffectWhereInput: ["AND", "OR", "NOT", "id", "name", "partName", "repeat", "frames", "editing"],
  LEDEffectOrderByWithRelationInput: ["id", "name", "partName", "repeat", "frames", "editing"],
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "name", "password", "editingPositionFrameId", "editingControlFrameId", "editingLEDEffectId"],
  UserOrderByWithRelationInput: ["id", "name", "password", "editingPositionFrameId", "editingControlFrameId", "editingLEDEffectId"],
  ...
  EditingLEDEffectWhereInput: ["AND", "OR", "NOT", "userId", "LEDEffectId", "user", "editingLEDEffect"],
  EditingLEDEffectOrderByWithRelationInput: ["userId", "LEDEffectId", "user", "editingLEDEffect"],
  EditingLEDEffectWhereUniqueInput: ["userId", "LEDEffectId"],
  EditingLEDEffectOrderByWithAggregationInput: ["userId", "LEDEffectId", "_count", "_avg", "_max", "_min", "_sum"],
  EditingLEDEffectScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "userId", "LEDEffectId"],
  DancerWhereInput: ["AND", "OR", "NOT", "id", "name", "parts", "positionData"],
  DancerOrderByWithRelationInput: ["id", "name", "parts", "positionData"],
  DancerWhereUniqueInput: ["id", "name"],
  ...
  PartWhereInput: ["AND", "OR", "NOT", "id", "dancerId", "name", "type", "length", "dancer", "controlData"],
  PartOrderByWithRelationInput: ["id", "dancerId", "name", "type", "length", "dancer", "controlData"],
  PartWhereUniqueInput: ["id"],
  PartOrderByWithAggregationInput: ["id", "dancerId", "name", "type", "length", "_count", "_avg", "_max", "_min", "_sum"],
  PartScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "dancerId", "name", "type", "length"],
  ...
  ColorCreateManyInput: ["id", "color", "colorCode"],
  ColorUpdateManyMutationInput: ["color", "colorCode"],
  LEDEffectCreateInput: ["name", "partName", "repeat", "frames", "editing"],
  LEDEffectUpdateInput: ["name", "partName", "repeat", "frames", "editing"],
  LEDEffectCreateManyInput: ["id", "name", "partName", "repeat", "frames"],
  LEDEffectUpdateManyMutationInput: ["name", "partName", "repeat", "frames"],
  UserCreateInput: ["name", "password", "editingPositionFrameId", "editingControlFrameId", "editingLEDEffectId"],
  UserUpdateInput: ["name", "password", "editingPositionFrameId", "editingControlFrameId", "editingLEDEffectId"],
  ...
  EditingLEDEffectCreateInput: ["user", "editingLEDEffect"],
  EditingLEDEffectUpdateInput: ["user", "editingLEDEffect"],
  EditingLEDEffectCreateManyInput: ["userId", "LEDEffectId"],
  EditingLEDEffectUpdateManyMutationInput: [],
  ...
  PartCreateInput: ["name", "type", "length", "dancer", "controlData"],
  PartUpdateInput: ["name", "type", "length", "dancer", "controlData"],
  PartCreateManyInput: ["id", "dancerId", "name", "type", "length"],
  PartUpdateManyMutationInput: ["name", "type", "length"],
  ...
  ColorCountOrderByAggregateInput: ["id", "color", "colorCode"],
  ColorAvgOrderByAggregateInput: ["id", "colorCode"],
  ColorMaxOrderByAggregateInput: ["id", "color"],
  ColorMinOrderByAggregateInput: ["id", "color"],
  ColorSumOrderByAggregateInput: ["id", "colorCode"],
  IntWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
  StringWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "mode", "not", "_count", "_min", "_max"],
  JsonNullableListFilter: ["equals", "has", "hasEvery", "hasSome", "isEmpty"],
  EditingLEDEffectRelationFilter: ["is", "isNot"],
  ...
  LEDEffectRelationFilter: ["is", "isNot"],
  EditingLEDEffectCountOrderByAggregateInput: ["userId", "LEDEffectId"],
  EditingLEDEffectAvgOrderByAggregateInput: ["userId", "LEDEffectId"],
  EditingLEDEffectMaxOrderByAggregateInput: ["userId", "LEDEffectId"],
  EditingLEDEffectMinOrderByAggregateInput: ["userId", "LEDEffectId"],
  EditingLEDEffectSumOrderByAggregateInput: ["userId", "LEDEffectId"],
  ...
  PartCountOrderByAggregateInput: ["id", "dancerId", "name", "type", "length"],
  PartAvgOrderByAggregateInput: ["id", "dancerId", "length"],
  PartMaxOrderByAggregateInput: ["id", "dancerId", "name", "type", "length"],
  PartMinOrderByAggregateInput: ["id", "dancerId", "name", "type", "length"],
  PartSumOrderByAggregateInput: ["id", "dancerId", "length"],
  ...
  ColorCreatecolorCodeInput: ["set"],
  StringFieldUpdateOperationsInput: ["set"],
  ColorUpdatecolorCodeInput: ["set", "push"],
  IntFieldUpdateOperationsInput: ["set", "increment", "decrement", "multiply", "divide"],
  LEDEffectCreateframesInput: ["set"],
  EditingLEDEffectCreateNestedOneWithoutEditingLEDEffectInput: ["create", "connectOrCreate", "connect"],
  LEDEffectUpdateframesInput: ["set", "push"],
  EditingLEDEffectUpdateOneWithoutEditingLEDEffectNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  EditingLEDEffectCreateNestedOneWithoutUserInput: ["create", "connectOrCreate", "connect"],
  ...
  EditingLEDEffectUpdateOneWithoutUserNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  UserCreateNestedOneWithoutEditingLEDEffectIdInput: ["create", "connectOrCreate", "connect"],
  LEDEffectCreateNestedOneWithoutEditingInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutEditingLEDEffectIdNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  LEDEffectUpdateOneWithoutEditingNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  EditingLEDEffectCreateWithoutEditingLEDEffectInput: ["user"],
  EditingLEDEffectCreateOrConnectWithoutEditingLEDEffectInput: ["where", "create"],
  EditingLEDEffectUpsertWithoutEditingLEDEffectInput: ["update", "create"],
  EditingLEDEffectUpdateWithoutEditingLEDEffectInput: ["user"],
  ...
  EditingLEDEffectCreateWithoutUserInput: ["editingLEDEffect"],
  EditingLEDEffectCreateOrConnectWithoutUserInput: ["where", "create"],
  ...
  EditingLEDEffectUpsertWithoutUserInput: ["update", "create"],
  EditingLEDEffectUpdateWithoutUserInput: ["editingLEDEffect"],
  UserCreateWithoutEditingPositionFrameIdInput: ["name", "password", "editingControlFrameId", "editingLEDEffectId"],
  ...
  UserUpdateWithoutEditingPositionFrameIdInput: ["name", "password", "editingControlFrameId", "editingLEDEffectId"],
  PositionFrameUpsertWithoutEditingInput: ["update", "create"],
  PositionFrameUpdateWithoutEditingInput: ["start", "positionDatas"],
  UserCreateWithoutEditingControlFrameIdInput: ["name", "password", "editingPositionFrameId", "editingLEDEffectId"],
  ...
  UserUpdateWithoutEditingControlFrameIdInput: ["name", "password", "editingPositionFrameId", "editingLEDEffectId"],
  ControlFrameUpsertWithoutEditingInput: ["update", "create"],
  ControlFrameUpdateWithoutEditingInput: ["start", "fade", "controlDatas"],
  UserCreateWithoutEditingLEDEffectIdInput: ["name", "password", "editingPositionFrameId", "editingControlFrameId"],
  UserCreateOrConnectWithoutEditingLEDEffectIdInput: ["where", "create"],
  LEDEffectCreateWithoutEditingInput: ["name", "partName", "repeat", "frames"],
  LEDEffectCreateOrConnectWithoutEditingInput: ["where", "create"],
  UserUpsertWithoutEditingLEDEffectIdInput: ["update", "create"],
  UserUpdateWithoutEditingLEDEffectIdInput: ["name", "password", "editingPositionFrameId", "editingControlFrameId"],
  LEDEffectUpsertWithoutEditingInput: ["update", "create"],
  LEDEffectUpdateWithoutEditingInput: ["name", "partName", "repeat", "frames"],
  PartCreateWithoutDancerInput: ["name", "type", "length", "controlData"],
  ...
  PartScalarWhereInput: ["AND", "OR", "NOT", "id", "dancerId", "name", "type", "length"],
  ...
  PartCreateWithoutControlDataInput: ["name", "type", "length", "dancer"],
  ...
  PartUpdateWithoutControlDataInput: ["name", "type", "length", "dancer"],
  ...
  PartCreateManyDancerInput: ["id", "name", "type", "length"],
  PositionDataCreateManyDancerInput: ["frameId", "x", "y", "z"],
  PartUpdateWithoutDancerInput: ["name", "type", "length", "controlData"],
